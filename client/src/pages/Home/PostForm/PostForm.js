...
const PostForm = ({ members }) => {
  ...
  return (
    <div className="postform">
      <Header date={date} setDate={setDate} postAttempt={postAttempt}/>
      <div className="postform__content">
        ...
        <div className="postform__divider" />
        <Songs songs={songs} setSongs={setSongs} postAttempt={postAttempt} />
      </div>
      <button className="postform__submit" onClick={handleSubmitPost}>
        Post Lineup
      </button>
    </div>
  );
